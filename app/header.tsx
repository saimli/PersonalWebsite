                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="hidden md:flex items-center space-x-8">
                            <button 
                                ...
                                className="text-white hover:text-gray-300 transition-colors duration-200 text-sm sm:text-base md:text-lg"
                            >
                                Home
                            </button>
                            <button 
                        ...
                        <div className="hidden md:flex items-center space-x-4">
                            <a href="https://github.com/saimli" target="_blank" rel="noopener noreferrer" className="text-white hover:text-gray-300">
                            ...
                            <a href="https://www.linkedin.com/in/saim-ali-864702239/" target="_blank" rel="noopener noreferrer" className="text-white hover:text-gray-300">
                                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    {isMenuOpen && (
                        <div className="md:hidden pt-4 pb-2">
                            <div className="flex flex-col items-center space-y-3 text-center">
                                <button 
                                    onClick={() => handleNavClick('about')}
                                    className="text-white hover:text-gray-300 transition-colors duration-200 text-base sm:text-lg"
                                >
                                    Home
                                </button>
                                <button 
